...
# LLM Models
LLM = "/workspace/gym/vbot/models/llama-2-13b-chat.ggmlv3.q4_1.bin"   # Slow
# LLM = "/workspace/gym/vbot/models/llama-2-7b-chat.ggmlv3.q8_0.bin"     # Fast
# LLM = "/workspace/gym/vbot/models/llama-2-7b-chat.ggmlv3.q4_K_M.bin"
